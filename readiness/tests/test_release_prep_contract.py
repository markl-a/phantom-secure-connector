...
def test_ci_runs_release_prep_gate() -> None:
    ...
    assert "python -m pytest readiness/tests/test_release_prep_contract.py -q" in workflow
    assert "python -m pytest -q" in workflow
    assert "python -m readiness.demo_loop --out" in workflow
    assert "python -m readiness.guard_scenario --source" in workflow
